...
@section('headerlabel','Plans')

@section('headerSubLabel','Create')

@section('title','Create Plans')

@section('topbarbutton')
<a href="{{route('settings.user.index')}}" class="btn btn-default font-weight-bold ml-2">Cancel</a>
                 <button type="button" onclick="createPlan()" class="btn btn-primary font-weight-bold ml-2"><i class="fa fa-save"></i> Save</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <h6 class=" text-dark font-weight-bold mb-10">Subscription Plans:</h6>
                                </div>
                            </div>
                            <!--end::Row-->
                                              <!--begin::Group-->
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-3 text-lg-right text-left">Plan  Name</label>
                                <div class="col-9">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-form-label col-3 text-lg-right text-left">Plan Description</label>
                                <div class="col-9">
